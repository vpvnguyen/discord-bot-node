...
const help = async (message, _args) => {
  const embed = createEmbed({
    color: "#303136",
    author: {
      name: "COVID Stats by puf17640",
      url:
        "https://cdn.discordapp.com/icons/707227171835609108/f308f34a45ac7644506fb628215a3793.png?size=128",
    },
    title: `All commands`,
    fields: [
      {
      ...
      },
      {
        name: "Country",
        value:
          "`cov country {country}`\nshows detailed COVID stats for a country",
        inline: true,
      },
      {
        name: "Graph",
        value:
          "`cov graph {country|all} [{log|linear}]`\nshows a graph with cases, active, deaths and recovered",
        inline: true,
      },
      {
        name: "Overview",
        value:
          "`cov overview {country|all}`\nshows an overview chart with active, deaths and recovered",
        inline: true,
      },
      {
        name: "State",
        value: "`cov state {state}`\nshows detailed COVID stats for a US state",
        inline: true,
      },
      {
        name: "Leaderboard",
        value:
          "`cov leaderboard [{property}]`\nshows detailed COVID stats for a US state",
        inline: true,
      },
      {
        name: "Mobility",
        value:
          "`cov mobility {country} [{subregion}]`\nshows Apples mobility data in a graph",
        inline: true,
      },
      {
        name: "Mobility + History",
        value:
          "`cov mh {country}`\nshows Apples mobility data + historical timeline in a graph",
        inline: true,
      },
      {
        name: "Country Compare",
        value:
          "`cov compare {country} {country}`\nshows a detailed comparison of 2 countries",
        inline: true,
      },
...
const invite = async (message) => {
  const embed = createEmbed({
    ...
    title: `Invite`,
    url:
      "https://discord.com/api/oauth2/authorize?client_id=707564241279909888&permissions=51200&scope=bot",
  });
  await message.channel.send(embed);
};
...
const all = async (message) => {
  ...
  const embed = createEmbed({
    ...
    fields: [
      {
        name: "Cases",
        value: `${formatNumber(allData.cases)}\n(${
          (allData.todayCases >= 0 ? "+" : "-") +
          String(Math.abs(allData.todayCases)).replace(
            /(.)(?=(\d{3})+$)/g,
            "$1,"
          )
        })`,
      ...
      {
        name: "Deaths",
        value: `${formatNumber(allData.deaths)}\n(${
          (allData.todayDeaths >= 0 ? "+" : "-") +
          String(Math.abs(allData.todayDeaths)).replace(
            /(.)(?=(\d{3})+$)/g,
            "$1,"
          )
        })`,
      ...
      {
        name: "Active",
        value: `${formatNumber(allData.active)}\n(${
          (allData.todayActives >= 0 ? "+" : "-") +
          String(Math.abs(allData.todayActives)).replace(
            /(.)(?=(\d{3})+$)/g,
            "$1,"
          )
        })`,
      ...
      {
        name: "Recovered",
        value: `${formatNumber(allData.recovered)}\n(${
          (allData.todayRecovereds >= 0 ? "+" : "-") +
          String(Math.abs(allData.todayRecovereds)).replace(
            /(.)(?=(\d{3})+$)/g,
            "$1,"
          )
        })`,
      ...
      {
        name: "Critical",
        value: `${formatNumber(allData.critical)}\n(${
          (allData.todayCriticals >= 0 ? "+" : "-") +
          String(Math.abs(allData.todayCriticals)).replace(
            /(.)(?=(\d{3})+$)/g,
            "$1,"
          )
        })`,
      ...
      {
        name: "Tests",
        value: `${formatNumber(allData.tests)}\n(${
          (allData.todayTests >= 0 ? "+" : "-") +
          String(Math.abs(allData.todayTests)).replace(
            /(.)(?=(\d{3})+$)/g,
            "$1,"
          )
        })`,
      ...
      {
        name: "Population",
        value: formatNumber(allData.population),
        inline: true,
      },
      {
        name: "Infection Rate",
        value: `${(allData.casesPerOneMillion / 10000).toFixed(4)} %`,
        inline: true,
      },
      {
        name: "Fatality Rate",
        value: `${((allData.deaths / allData.cases) * 100).toFixed(4)} %`,
        inline: true,
      },
      {
        name: "Critical Rate",
        value: `${((allData.critical / allData.active) * 100).toFixed(4)} %`,
        inline: true,
      },
      {
        name: "Recovery Rate",
        value: `${((allData.recovered / allData.cases) * 100).toFixed(4)} %`,
        inline: true,
      },
      {
        name: "Test Rate",
        value: `${(allData.testsPerOneMillion / 10000).toFixed(4)} %`,
        inline: true,
      },
      {
        name: "Infected Countries",
        value: allData.affectedCountries,
        inline: true,
      },
      {
        name: "Last Updated",
        value: moment(allData.updated).fromNow(),
        inline: true,
      },
    ],
    url: "https://pufler.dev",
...
const country = async (message, args) => {
  ...
  if (countryData.message || yesterdayCountryData.message)
    return await message.channel.send(
      countryData.message || yesterdayCountryData.message
    );
  countryData.todayActives = countryData.active - yesterdayCountryData.active;
  countryData.todayRecovereds =
    countryData.recovered - yesterdayCountryData.recovered;
  countryData.todayCriticals =
    countryData.critical - yesterdayCountryData.critical;
  ...
  const embed = createEmbed({
    ...
    fields: [
      {
        name: "Cases",
        value: `${formatNumber(countryData.cases)}\n(${
          (countryData.todayCases >= 0 ? "+" : "-") +
          String(Math.abs(countryData.todayCases)).replace(
            /(.)(?=(\d{3})+$)/g,
            "$1,"
          )
        })`,
      ...
      {
        name: "Deaths",
        value: `${formatNumber(countryData.deaths)}\n(${
          (countryData.todayDeaths >= 0 ? "+" : "-") +
          String(Math.abs(countryData.todayDeaths)).replace(
            /(.)(?=(\d{3})+$)/g,
            "$1,"
          )
        })`,
      ...
      {
        name: "Active",
        value: `${formatNumber(countryData.active)}\n(${
          (countryData.todayActives >= 0 ? "+" : "-") +
          String(Math.abs(countryData.todayActives)).replace(
            /(.)(?=(\d{3})+$)/g,
            "$1,"
          )
        })`,
      ...
      {
        name: "Recovered",
        value: `${formatNumber(countryData.recovered)}\n(${
          (countryData.todayRecovereds >= 0 ? "+" : "-") +
          String(Math.abs(countryData.todayRecovereds)).replace(
            /(.)(?=(\d{3})+$)/g,
            "$1,"
          )
        })`,
      ...
      {
        name: "Critical",
        value: `${formatNumber(countryData.critical)}\n(${
          (countryData.todayCriticals >= 0 ? "+" : "-") +
          String(Math.abs(countryData.todayCriticals)).replace(
            /(.)(?=(\d{3})+$)/g,
            "$1,"
          )
        })`,
      ...
      {
        name: "Tests",
        value: `${formatNumber(countryData.tests)}\n(${
          (countryData.todayTests >= 0 ? "+" : "-") +
          String(Math.abs(countryData.todayTests)).replace(
            /(.)(?=(\d{3})+$)/g,
            "$1,"
          )
        })`,
      ...
      {
        name: "Infection Rate",
        value: `${(countryData.casesPerOneMillion / 10000).toFixed(4)} %`,
        inline: true,
      },
      {
        name: "Fatality Rate",
        value: `${((countryData.deaths / countryData.cases) * 100).toFixed(
          4
        )} %`,
        inline: true,
      },
      {
        name: "Critical Rate",
        value: `${((countryData.critical / countryData.active) * 100).toFixed(
          4
        )} %`,
        inline: true,
      },
      {
        name: "Recovery Rate",
        value: `${((countryData.recovered / countryData.cases) * 100).toFixed(
          4
        )} %`,
        inline: true,
      },
      {
        name: "Test Rate",
        value: `${(countryData.testsPerOneMillion / 10000).toFixed(4)} %`,
        inline: true,
      },
      {
        name: "Last Updated",
...
const graph = async (message, args) => {
  if (args.length < 1)
    return await message.channel.send("Please specify a country name.");
  const lineData = ["global", "all"].includes(args[0].toLowerCase())
    ? { timeline: await api.historical.all({ days: -1 }) }
    : await api.historical.countries({ country: args[0], days: -1 });
  if (lineData.message) return await message.channel.send(lineData.message);
  const datasets = [
    {
      label: "Cases",
      borderColor: "#ffffff",
...
const overview = async (message, args) => {
  ...
  const pieData = ["global", "all"].includes(args[0].toLowerCase())
    ? await api.all()
    : await api.countries({ country: args[0] });
  if (pieData.message) return await message.channel.send(pieData.message);
...
const state = async (message, args) => {
  ...
  const yesterdayStateData = await api.yesterday.states({
    state: args.join(" "),
  });
  ...
  const embed = createEmbed({
    ...
    fields: [
      {
        name: "Cases",
        value: `${formatNumber(stateData.cases)}\n(${
      ...
      {
        name: "Deaths",
        value: `${formatNumber(stateData.deaths)}\n(${
      ...
      {
        name: "Active",
        value: `${formatNumber(stateData.active)}\n(${
      ...
      {
        name: "Tests",
        value: `${formatNumber(stateData.tests)}\n(${
      ...
      {
        name: "Test Rate",
        value: `${(stateData.testsPerOneMillion / 10000).toFixed(4)} %`,
        inline: true,
      },
      {
        name: "Last Updated",
...
const leaderboard = async (message, args) => {
  const allData = await api.all();
  const sorter = Object.keys(sortables).includes(
    args[0] && args[0].toLowerCase()
  )
    ? sortables[args[0].toLowerCase()] || args[0].toLowerCase()
    : "cases";
...
const mobility = async (message, args) => {
  if (args.length < 1)
    return await message.reply("Please specify a country name.");
  const mobData = await api.apple.mobilityData({
    country: args[0],
    subregion: args[1] || "All",
  });
  if (mobData.message) return await message.channel.send(mobData.message);
  const datasets = [
    {
      label: "Walking",
      borderColor: "#FAE29F",
  ...
  const embed = createEmbed({
    ...
    description:
      "Data is provided by Apple. All values are relative to those from 13th Jan.",
    files: [new Discord.MessageAttachment(buffer, "graph.png")],
    image: "attachment://graph.png",
    url: "https://pufler.dev",
  });
...
const mobilityHistory = async (message, args) => {
  ...
  const lineData = await api.historical.countries({
    country: args[0],
    days: -1,
  });
...
const compare = async (message, args) => {
  ...
  if (data.find((c) => c.message))
    return await message.channel.send(
      data.map((c) => c.message).filter((x) => x)
    );
  ...
  const embed = createEmbed({
    ...
    fields: [
      {
        name: "Cases",
        value: `**${data[0].country}**: ${formatNumber(data[0].cases)} (${
          (data[0].todayCases >= 0 ? "+" : "-") +
          String(Math.abs(data[0].todayCases)).replace(
            /(.)(?=(\d{3})+$)/g,
            "$1,"
          )
        })\n**${data[1].country}**: ${formatNumber(data[1].cases)} (${
          (data[1].todayCases >= 0 ? "+" : "-") +
          String(Math.abs(data[1].todayCases)).replace(
            /(.)(?=(\d{3})+$)/g,
            "$1,"
          )
        })`,
      ...
      {
        name: "Deaths",
        value: `**${data[0].country}**: ${formatNumber(data[0].deaths)} (${
          (data[0].todayDeaths >= 0 ? "+" : "-") +
          String(Math.abs(data[0].todayDeaths)).replace(
            /(.)(?=(\d{3})+$)/g,
            "$1,"
          )
        })\n**${data[1].country}**: ${formatNumber(data[1].deaths)} (${
          (data[1].todayDeaths >= 0 ? "+" : "-") +
          String(Math.abs(data[1].todayDeaths)).replace(
            /(.)(?=(\d{3})+$)/g,
            "$1,"
          )
        })`,
      ...
      {
        name: "Active",
        value: `**${data[0].country}**: ${formatNumber(data[0].active)} (${
          (data[0].todayActives >= 0 ? "+" : "-") +
          String(Math.abs(data[0].todayActives)).replace(
            /(.)(?=(\d{3})+$)/g,
            "$1,"
          )
        })\n**${data[1].country}**: ${formatNumber(data[1].active)} (${
          (data[1].todayActives >= 0 ? "+" : "-") +
          String(Math.abs(data[1].todayActives)).replace(
            /(.)(?=(\d{3})+$)/g,
            "$1,"
          )
        })`,
      ...
      {
        name: "Recovered",
        value: `**${data[0].country}**: ${formatNumber(data[0].recovered)} (${
          (data[0].todayRecovereds >= 0 ? "+" : "-") +
          String(Math.abs(data[0].todayRecovereds)).replace(
            /(.)(?=(\d{3})+$)/g,
            "$1,"
          )
        })\n**${data[1].country}**: ${formatNumber(data[1].recovered)} (${
          (data[1].todayRecovereds >= 0 ? "+" : "-") +
          String(Math.abs(data[1].todayRecovereds)).replace(
            /(.)(?=(\d{3})+$)/g,
            "$1,"
          )
        })`,
      ...
      {
        name: "Critical",
        value: `**${data[0].country}**: ${formatNumber(data[0].critical)} (${
          (data[0].todayCriticals >= 0 ? "+" : "-") +
          String(Math.abs(data[0].todayCriticals)).replace(
            /(.)(?=(\d{3})+$)/g,
            "$1,"
          )
        })\n**${data[1].country}**: ${formatNumber(data[1].critical)} (${
          (data[1].todayCriticals >= 0 ? "+" : "-") +
          String(Math.abs(data[1].todayCriticals)).replace(
            /(.)(?=(\d{3})+$)/g,
            "$1,"
          )
        })`,
      ...
      {
        name: "Tests",
        value: `**${data[0].country}**: ${formatNumber(data[0].tests)} (${
          (data[0].todayTests >= 0 ? "+" : "-") +
          String(Math.abs(data[0].todayTests)).replace(
            /(.)(?=(\d{3})+$)/g,
            "$1,"
          )
        })\n**${data[1].country}**: ${formatNumber(data[1].tests)} (${
          (data[1].todayTests >= 0 ? "+" : "-") +
          String(Math.abs(data[1].todayTests)).replace(
            /(.)(?=(\d{3})+$)/g,
            "$1,"
          )
        })`,
      ...
      {
        name: "Population",
        value: `**${data[0].country}**: ${formatNumber(
          data[0].population
        )}\n**${data[1].country}**: ${formatNumber(data[1].population)}`,
        inline: true,
      },
      {
        name: "Infection Rate",
        value: `**${data[0].country}**: ${(
          data[0].casesPerOneMillion / 10000
        ).toFixed(4)} %\n**${data[1].country}**: ${(
          data[1].casesPerOneMillion / 10000
        ).toFixed(4)} %`,
        inline: true,
      },
      {
      ...
      },
      {
        name: "Critical Rate",
        value: `**${data[0].country}**: ${(
          (data[0].critical / data[0].active) *
          100
        ).toFixed(4)} %\n**${data[1].country}**: ${(
          (data[1].critical / data[1].active) *
          100
        ).toFixed(4)} %`,
        inline: true,
      },
      {
        name: "Recovery Rate",
        value: `**${data[0].country}**: ${(
          (data[0].recovered / data[0].cases) *
          100
        ).toFixed(4)} %\n**${data[1].country}**: ${(
          (data[1].recovered / data[1].cases) *
          100
        ).toFixed(4)} %`,
        inline: true,
      },
      {
        name: "Test Rate",
        value: `**${data[0].country}**: ${(
          data[0].testsPerOneMillion / 10000
        ).toFixed(4)} %\n**${data[1].country}**: ${(
          data[1].testsPerOneMillion / 10000
        ).toFixed(4)} %`,
        inline: true,
      },
...
const system = async (message, _args) => {
  ...
  const embed = createEmbed({
    ...
    fields: [
      ...
      {
        name: "Uptime",
        value: `${moment(+Date.now() - info.upTime).fromNow({
          withoutSuffix: true,
        })}`,
        inline: true,
      },
...
const analytics = async (message) => {
  const embed = createEmbed({
    ...
    title: "Analytics",
    fields: Object.entries(_analytics).map((e) => ({
      name: e[0],
      value: `${e[1]}x used`,
      inline: true,
    })),
